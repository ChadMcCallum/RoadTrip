...
var hotelShadow = new google.maps.MarkerImage(
  'hotel/marker-images/shadow.png',
  new google.maps.Size(100, 64),
  new google.maps.Point(0, 0),
  new google.maps.Point(0, 64)
);
